    ...
    <>
      <style jsx>{`
        ...
        .shiny-cta {
          ...
          --shiny-cta-fg: #ffffff;
          --shiny-cta-highlight: #7a7a7a;
          --shiny-cta-highlight-subtle: #b5b5b5;
          --shiny-cta-dot: rgba(255, 255, 255, 0.95);
        ...
        .shiny-cta::before {
          ...
          background: radial-gradient(
              ...
              var(--shiny-cta-dot) calc(var(--position) / 3),
              transparent 0
            )
            padding-box;
      ...
      <button type="button" className={`shiny-cta ${className}`} onClick={onClick} style={style}>
        <span>{children}</span>
      </button>
    </>
  );
