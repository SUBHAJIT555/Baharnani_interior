    ...
    () => {
      ...
      const build = () => {
        ...
        chars.forEach((ch) => {
          ...
          if (colorFrom) (inner.style as CSSStyleDeclaration).color = colorFrom;
      ...
      const armHover = () => {
        ...
        removeHover();
        const target =
          hoverTarget === "parent-group" ? (ref.current.closest(".group") as HTMLElement | null) || ref.current : ref.current;
        const handler = () => {
